...
public class Principal {
	public static void main(String[] args) {				
		...
		Gestor contabilidad = new Gestor("C:\\Users\\amigu\\git\\contabilidadUIA-AS\\contabilidadUIA\\ListaProveedores.json");		
		 ...
		 cheque.Print();
		 cuenta = (Cuenta) gestorCuentas.busca("Alfonso-compra-A-cuenta-1");
		 cuenta.Print();
		 cuenta.registraCXP("Alfonso-compra-A-cuenta-1-Req-Cheques-ChequesX", gestorCuentas.getCatalogo());
		 cuenta.Print();
